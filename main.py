...
<head>
    ...
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        /* Стиль для кнопки-кружечка інформації */
        .info-circle {{
            position: absolute;
            top: 20px;
            right: 20px;
        ...
        /* Контейнер таблиці з горизонтальною прокруткою для мобільних */
        .table-container {{
            padding: 15px 20px;
            flex: 1;
            overflow-x: auto;
        ...
        /* Медіа-запит для адаптації на телефонах */
...
<div class="container">
    ...
    <div class="table-container">
        <table id="slangTable" style="width: 100%;">
...
<!-- Модальне вікно для деталей слова -->
...
<!-- Модальне вікно для інформації про словник -->
<div id="infoModal" class="modal">
    <div class="modal-content">
        ...
        <ul style="margin-left: 20px; line-height: 1.6;">
            <li><strong>Фільтри</strong> — обирайте сферу сленгу або емоційне забарвлення, щоб звузити пошук</li>
            ...
            <li><strong>Контексти</strong> — кожне слово супроводжується прикладом з серіалу англійською та українською мовами</li>
        </ul>
...
<script>
    ...
    function selectSuggestion(word) {{
        ...
        // Фільтруємо таблицю за вибраним словом
        const sphere = document.getElementById('sphereFilter').value;
        const emotion = document.getElementById('emotionFilter').value;
